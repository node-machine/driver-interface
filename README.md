...
+ [`.parseNativeQueryResult()`](./layers/queryable/parse-native-query-result.js) _(will potentially be consolidated into `sendNativeQuery` and conditionally enabled through use of optional input)_
