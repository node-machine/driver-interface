module.exports = {
  ...
  exits: {
    ...
    success: {
      description: 'The normalization was successful.',
      extendedDescription: 'If the error cannot be normalized into any other more specific footprint, then the catchall footprint will be used.  The footprint (`footprint`) will be coerced to a JSON-serializable dictionary if it isn\'t one already (see [rttc.dehydrate()](https://github.com/node-machine/rttc#dehydratevalue-allownullfalse-dontstringifyfunctionsfalse)). That means any Error instances therein will be converted to stacktrace strings.',
